...
**Figure 1:** 
Synthetic _Horizons_ data for asteroid 2024 ON (Sept 5–6, 2024, 1 hour cadence, 48 observations, and 20mas Gaussian noise added to make the RA and DEC values more realistic) and code to reproduce the figure. 

**Figure 2:** 
(Similar to Figure 1) Synthetic _Horizons_ data for asteroid 4953/1990 MU (Oct 30–31, 2024, 1 hour cadence, 48 observations, and 20mas Gaussian noise added to make the RA and DEC values more realistic) and corresponding code.

**Figure 3:** 
Synthetic _Horizons_ data for 20 asteroids over a short observational arc of ~4 hours (Sept 5–6, 2024, and 20mas Gaussian noise added to make the RA and DEC values more realistic) with code for distance-measurements.
